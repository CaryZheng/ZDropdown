...
public class ZDropdown : UIView, IZDropdownView, IZDropdownContainer
{
    public var mDefaultSetting = "请选择"
    public var mCurrentSelectedIndex = -1
    
    private var mDataNameList = Array<String>()
    private var mDataCodeList = Array<AnyObject>()
    ...
    public func getTitleTag() -> AnyObject?
    {
    ...
    public func getCurrentSelectedCode() -> AnyObject?
    {
    ...
    public func getCurrentSelectedName() -> String?
    {
        if(-1 == mCurrentSelectedIndex)
        {
            return nil
    ...
    public func setData(dataList: Array<String>)
    {
    ...
    public func setDataCode(dataList: Array<AnyObject>)
    {
